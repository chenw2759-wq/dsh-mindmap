 ...
 * it toggles the preview drawer. The mindmap STYLE is chosen in the composer
 * (新建会话界面, next to the preset/mode chip) — see composer-style-entry.ts.
 * Self-healing via a MutationObserver on sidebar re-renders.
 *
